...
function RequirementCard({
  ...
  return (
    ...
    <article className="border border-[#aeb4ad] bg-[#f8f5ec]">
        ...
        <div className="flex flex-wrap items-center gap-3 lg:pt-1">
          ...
          {match.status === "contacted" && (
            ...
            <button
              ...
              className="bg-[#bd4f2d] px-5 py-3 font-mono text-[8px] font-bold uppercase tracking-[0.15em] text-white transition hover:bg-[#a94426] disabled:cursor-not-allowed disabled:opacity-60"
            >
        ...
        <div className="px-6 py-6">
          ...
          <div className="mt-5 space-y-4">
            ...
            <ScoreBar
              ...
              value={
                match.breakdown.semantic_similarity * 100
              }
            />
      ...
      <div className="flex flex-col gap-3 border-t border-[#d0d3cc] bg-[#eef0ea] px-6 py-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          {match.status === "contacted" && (
            ...
            <button
              ...
              className="bg-[#26312c] px-5 py-2.5 font-mono text-[8px] font-bold uppercase tracking-[0.14em] text-[#f4f0e5] transition hover:bg-[#18221e] disabled:opacity-60"
            >
              {acceptingMatchId === match.id
                ? "Accepting..."
                : "Accept Match →"}
...
export default function SupplierMatchesPage() {
  ...
  const [acceptingMatchId, setAcceptingMatchId] =
    useState("");
              ...
              <section className="mt-8 border border-[#aeb4ad] bg-[#f8f5ec]">
                ...
                <div className="px-6 py-12 text-center">
                  ...
                  <p className="font-serif text-[16px] text-[#59625c]">
                    Your supplier offerings have not generated any buyer
                    matches yet.
                  </p>
